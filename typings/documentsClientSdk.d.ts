declare namespace documents {
    namespace sdk {
        namespace utils {
            ...
            /**
             * Parses a date string and returns either a ECMAScript or a [Moment.js]{@link https://momentjs.com/docs/} Date object.
             * This method expects a string with the date format of the current user, for example by using {@link FileContext#getFileFieldValue} on a Date or Timestamp field.
        ...
        namespace gentable {
            namespace grid {
                 ...
                 */
                function getSelectedRows(): documents.sdk.gentable.grid.GentableGridRowCollection;
                 ...
                 * @see [resetSelectedRows]{@link documents.sdk.gentable.grid.GentableGridModel#resetSelectedRows}
                 */
                function setSelectedRows(indexes: number[]): void;
                 ...
                 */
                function setEditCell(options: Object): void;
                 ...
                 */
                function getActiveRow(): documents.sdk.gentable.grid.GentableGridRowModel;
            ...
            class GentableContext {
                /**
                 * The GentableContext provides full access to the {@link documents.sdk.gentable.grid.GentableGridModel|GentableGridModel},
        ...
        namespace exitRegistry {
             ...
             *        <code>File.afterSetModelData</code> (e.g. for modifications of the `FileFormModel`)<br>
             *        <code>File.beforeFileRender</code><br>
             *        <code>File.afterFileRender</code><br>
             *        <code>File.afterFileOpen</code><br>
             *        <code>File.beforeFileEditStart</code> (optionally aborts the file edit start action if `fn` returns `false`)<br>
             *        <code>File.afterFileEditStart</code><br>
             *        <code>File.beforeFileEditCancel</code> (optionally aborts the file edit cancel action if `fn` returns `false`)<br>
             *        <code>File.afterFileEditCancel</code><br>
             *        <code>File.beforeFileEditCommit</code> (optionally aborts the file edit commit action if `fn` returns `false`)<br>
             *        <code>File.afterFileEditCommit</code><br>
             *        <code>File.beforeFileCustomAction</code> (optionally aborts the file custom action if `fn` returns `false`)<br>
             *        <code>File.afterFileCustomAction</code><br>
             *        <code>File.beforeFileWorkflowAction</code> (optionally aborts the file workflow action if `fn` returns `false`)<br>
             *        <code>File.afterFileWorkflowAction</code><br>
             *        <code>File.beforeFileAction</code><br>
             *        <code>File.afterFileAction</code><br>
             *        <code>FileEmail.recipients</code> (file action dialog "send file as email")<br><br>
             ...
             * @param event the exit event name, i.e. one of the valid identifiers listed below<br><br>
             *        <code>ExtendedSearch.afterSetModelData</code> (e.g. for modifications of the `ExtendedSearchFormModel`)<br>
             ...
             *        <code>ExtendedSearch.beforeExecuteSearch</code> (optionally aborts the search action if `fn` returns `false`)<br>
             ...
             *        <code>DefaultSearch.beforeExecuteSearch</code> (optionally aborts the search action if `fn` returns `false`)<br>
             *        <code>DefaultSearch.afterExecuteSearch</code><br><br>
             * @param fn the function (or callback) that will be executed if the exit `event` occurs<br>`fn` will be called according to the function signature listed below
             * @see [DocumentsContext]{@link documents.sdk.DocumentsContext}
             ...
             * @param event the exit event name, i.e. one of the valid identifiers listed below<br><br>
             *        <code>ScriptParameter.afterSetModelData</code> (e.g. for modifications of the `ScriptParameterFormModel`)<br>
             *        <code>ScriptParameter.beforeRender</code><br>
             *        <code>ScriptParameter.afterRender</code><br>
             *        <code>ScriptParameter.beforeExecuteScript</code> (optionally aborts the script action if `fn` returns `false`)<br><br>
             * @param fn the function (or callback) that will be executed if the exit `event` occurs<br>`fn` will be called according to the function signature listed below
             * @see [DocumentsContext]{@link documents.sdk.DocumentsContext}
             */
        ...
        namespace dialogRegistry {
             ...
             * @see
             */
            function getDialogContext(dialogName: documents.sdk.dialogRegistry.dialogNameKey): documents.sdk.ExtendedSearchContext;
             ...
             */
            function hasDialogContext(dialogName: documents.sdk.dialogRegistry.dialogNameKey): boolean;

        }

        /**
         * Returns the Backbone Model of the dialog.
        ...
        class DocumentsContext {
             ...
             * {@link documents.sdk.UserContext|UserContext},
             * {@link documents.sdk.FileContext|FileContext},
             * {@link documents.sdk.GadgetContext|GadgetContext} and the
             * {@link documents.sdk.gentable.GentableContext|GentableContext}.
             */
            constructor();
            ...
            /**
             * This function logs out the user without returning to the login screen.
        ...
        class ExtendedSearchContext {
             ...
             * To modify the current search form _before_ being displayed, it is recommended to use this function
        ...
        abstract class FieldModel {
             ...
             * @see
             */
            setType(type: documents.sdk.FieldModelType): void;
            ...
            static Types: documents.sdk.FieldModelType;
        ...
        abstract class FormModel {
             ...
             * It contains a Collection of {@link documents.sdk.FieldModel|FieldModels} representing the fields.
             * @see [Backbone.Model]{@link http://backbonejs.org/#Model}
             * @see
             */
            constructor();
        ...
        class FileFormModel {
             ...
             * It contains a collection of {@link documents.sdk.FileFieldModel|FileFieldModels} representing the form fields.
             * @see [Backbone.Model]{@link http://backbonejs.org/#Model}
             * @see
             */
            constructor();
        ...
        class ExtendedSearchFormModel {
             ...
             * It contains a collection of {@link documents.sdk.SearchFieldModel|SearchFieldModels} representing the form fields.
             * @see [Backbone.Model]{@link http://backbonejs.org/#Model}
             * @see
             */
            constructor();
        ...
        class ScriptParameterFormModel {
             ...
             * It contains a collection of {@link documents.sdk.ScriptFieldModel|ScriptFieldModels} representing the form fields.
             * @see [Backbone.Model]{@link http://backbonejs.org/#Model}
             * @see
             */
            constructor();
        ...
        class FileContext {
             ...
             * To modify the current file form _before_ being displayed, it is recommended to use this function
        ...
        class GadgetContext {
             ...
             * * **ScriptList**: The `doby-grid` grid object is returned
             */
        ...
        class I18nContext {
             ...
             * @see
             */
            getMessages(propertiesFile: string): documents.sdk.I18nContextMessages;

        }

        interface I18nContextMessages {
            /**
             * 
        ...
        abstract class Storage {
             ...
             * Otherwise, an explicit [`save`]{@link documents.sdk.Storage.prototype#save} has to be performed to persist all the items that are currently present in the storage.
         ...
         * @see
         */
        function setType(type: documents.sdk.FieldModelType): void;
         ...
         * @returns readonly * @see {@link documents.sdk.FieldModel#isGuiReadonly|isGuiReadonly}
         */
        function isServerReadonly(): boolean;
         ...
         * @see
         */
        function isGuiReadonly(): boolean;
         ...
         * @see
         */
        function setGuiReadonly(guiReadonly: boolean): void;
         ...
         * @see
         */
        function getValue(): string | string[] | boolean;
         ...
         * @see
         */
        function setValue(value: string | string[] | boolean, options?: setValue_options): void;
         ...
         * @param options.addEmptyEntry `true` if an empty entry should be added to the enumValues. Default is `false`
         */
        function setEnumValues(enumValues: Object | Object[] | string | string[], options?: setEnumValues_options): void;

        /**
         * Returns if the field is in the same line as the preceding field or not.
         * @returns <code>true</code> if the field is in the same line as the preceding field, <code>false</code> otherwise
         */
        function isSameLine(): boolean;

        /**
         * Sets the field to the same line as the preceding field.
         * @param sameLine <code>true</code> for same line as the preceding field,  <code>false</code> otherwise
         */
        function setSameLine(sameLine: boolean): void;
         ...
         * @see [exitRegistry.registerScriptParameterFieldExitCallback]{@link documents.sdk.exitRegistry.registerScriptParameterFieldExitCallback}
         */
        function setExit(options?: setExit_options): void;
         ...
         * @param options.scriptParams additional parameter for the script
         */
        function setAutoComplete(options?: setAutoComplete_options): void;
...
declare interface openOutbar_options {
     ...
     * <em>OutbarPublicFolder</em>  //The outbar for public folders (Documents Manager - Settings - Documents (display) - Combined folder tree not checked)<br>
     * <em>OutbarPrivateFolder</em>  //The outbar for private folders (Documents Manager - Settings - Documents (display) - Combined folder tree not checked)<br>
     * <em>OutbarCombinedFolder</em>  //The outbar for a combination of public and private folders (Documents Manager - Settings - Documents (display) - Combined folder tree checked)<br>
     * <em>OutbarHitTree</em>  //The outbar for a hit tree (Documents Manager - Settings - Global Settings - Hit tree checked)<br>
     * User defined outbars can be accessed by their name (Documents Manager - settings - Outbars).</p>
     */
    name: string;
}
...
declare interface openTableDataDialog_options {
    /**
     * <p>custom handler function that is executed after the selection of a tabledata row entry, the selected data is available as a function parameter.<br>
     * Notice: If this option is set, none of the fields will be set automatically.</p>
     */
    onSelect: Function;
    /**
     * <p>the <code>options</code> object of the registered exit callback function, see examples below for details.<br>
     * Should be provided if <code>options.onSelect</code> option is not set.</p>
     */
    exitOptions: Object;
    /**
...
declare interface searchFieldExitCallback_options {
    /**
     * <p>the id of the search field</p>
     */
    searchFieldId: string;
    /**
     * <p>the technical name of the search field</p>
     */
...
declare interface fileFieldExitCallback_options {
    ...
    /**
     * <p>the file form model</p>
     */
    fileForm: documents.sdk.FileFormModel;
    /**
     * <p>the file field model</p>
     */
...
declare interface scriptParameterExitCallback_options {
    /**
     * <p>the technical name of the script</p>
     */
    scriptName: string;
    /**
     * <p>the script form model</p>
     */
...
declare interface scriptParameterFieldExitCallback_options {
    ...
    scriptName: string;
    /**
     * <p>the id of the script field</p>
     */
    scriptFieldId: string;
    /**
     * <p>the technical name of the script field</p>
     */
    scriptFieldName: string;
    /**
     * <p>the value of the script field</p>
     */
...
declare interface setAutoComplete_options {
    ...
    /**
     * <p>additional parameter for the script</p>
     */
    scriptParams: Object;
}
...
declare interface submitForm_options {
    /**
     * <p>validate the form before submit</p>
     */
    validateForm: boolean;
    /**
     * <p>show a busy panel on the container after submitting the form</p>
     */
...
declare interface parseDate_options {
    /**
     * <p>The type of the string to parse. Either &quot;date&quot; (default) or &quot;timestamp&quot;.</p>
     */
    fieldType: string;
    /**
     * <p>The type of the return object. Either &quot;ecma&quot; (default) or &quot;moment&quot;</p>
     */
    dateType: string;
}
...
declare interface formatDate_options {
    /**
     * <p>The type the Date object should be formatted to. Either &quot;date&quot; or &quot;timestamp&quot;</p>
     */
    fieldType: string;
    /**
     * <p>The input type of the Date. Either &quot;ecma&quot; (default) or &quot;moment&quot;</p>
     */
    dateType: string;
}
